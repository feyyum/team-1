...
;
var isRegistered = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Welcome to Caramel");
                return [4 /*yield*/, (0, promises_1.readFile)('team-1/cli/user-info.json', 'utf8')];
            case 1:
                data = _a.sent();
                ...
                if (user.API) {
                    ...
                    console.log("You need to register first.", "Please command: caramel authanticate <API_KEY>");
                }
                return [2 /*return*/];
        }
    });
