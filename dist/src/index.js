...
program.command('authanticate')
    ...
    .action((username, password, API_KEY) => { authanticate(username, password, API_KEY).then(() => { console.log("Enter source code file name:"); }); });
...
program.command('pk')
    ...
    .action((network_name, private_key) => getPK(network_name, private_key).
    then(() => {
